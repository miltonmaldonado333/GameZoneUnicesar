...
/**
 * Provides the business rules for managing accessories (controllers, cables and memories).
 * Acts as the intermediary between the user interface and the accessory persistence layer.
 */
...
public void registerMemory(String id, String title, double price, int stock, int capacity, String storageType) {
    ...
    /**
     * Creates an AccessoryService backed by the given repository.
     * Loads any previously stored accessories immediately.
     *
     ...
     *
     * @param type the type to filter by: "CONTROLLER", "CABLE" or "MEMORY" (case-insensitive)
    ...
    /**
     * Reduces the stock of an accessory by the given quantity (e.g. after a sale)
     ...
     * @return true if the update succeeded, false if the accessory was not found
