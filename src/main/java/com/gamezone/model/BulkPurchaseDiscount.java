...
/**
 * Promotion that applies a percentage discount if the sale meets or exceeds a
...
public class BulkPurchaseDiscount extends Promotion {
    ...
    public String getDetails() {
        return String.format("Type: Bulk Purchase | Min Quantity: %d | Discount: %.1f%%", minQuantity, percentage);
    }
}
